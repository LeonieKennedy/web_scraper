...
for i in range(0, 50):
    ...
    print(i)
    url = "https://fakeinfo.net/fake-facebook-chat-generator"
    driver.get(url)
    ...
    for j in range(1, 5):
        ...
        if previous_sender != sender:
            ...
            print("prev != send")
            driver.find_element(By.CSS_SELECTOR, "#left-panel > div > div:nth-child(2) > div:nth-child(4) > div > ul > li:nth-child("+sender+") > a").click()
